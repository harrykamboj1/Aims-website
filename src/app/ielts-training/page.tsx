...
export const metadata: Metadata = {
    ...
    description:
        "Get top IELTS scores with AIMS expert coaching. Comprehensive IELTS training covering all 4 modules - Listening, Reading, Writing, Speaking. 95% success rate. Free mock tests, personalized feedback & flexible schedules. Join 500+ successful students in Surrey, Canada & Ferozepur, India.",
    keywords: [
        "IELTS training",
        "IELTS coaching",
        "IELTS preparation",
    ...
    openGraph: {
        ...
        description:
            "Expert IELTS preparation with comprehensive training for all 4 modules. Join 500+ successful students. Free demo class available!",
