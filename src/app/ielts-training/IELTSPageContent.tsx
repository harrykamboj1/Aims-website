...
const IELTSPageContent = () => {
    ...
    const features = [
        ...
        },
        {
            ...
            description: "Customized study plans based on your strengths & weaknesses",
        },
    ];
                ...
                <div className="container-custom relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        >
                            ...
                            expert instructors, and comprehensive training program. Join 500+
                    ...
                    <div className="max-w-2xl mx-auto">
                        ...
                        >
                            ...
                            <p className="text-gray-600">
                                Completed your IELTS with AIMS? Share your experience and help future students!
                            </p>
                        </motion.div>
