...
const FrenchPageContent = () => {
    ...
    return (
        <main className="min-h-screen">
            ...
            {/* Hero Section */}
            <section className="pt-24 pb-16 md:pt-32 md:pb-24 bg-gradient-to-br from-blue-600/10 via-white to-red-500/10 relative overflow-hidden">
                ...
                <div className="container-custom relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        >
                            ...
                            <span>Parlez-vous français?</span>
                        </motion.div>
                        ...
                        >
                            Master the language of love with our comprehensive French training
                            program. From complete beginners to advanced speakers — we help
                            you achieve fluency for immigration, career, or personal growth!
                        </motion.p>
