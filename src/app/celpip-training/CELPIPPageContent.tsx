...
const CELPIPPageContent = () => {
  ...
  const whyCELPIP = [
    {
      ...
      title: "100% Canadian",
      description:
        "Designed specifically for Canadian immigration & citizenship",
    },
    {
      icon: Clock,
      title: "Fast Results",
  ...
  return (
    <main className="min-h-screen">
      ...
      <PageHero
        badge="Canadian English Experts"
        badgeIcon={Flag}
        title={
          <>
            Master CELPIP with{" "}
        ...
        description="Achieve your target CLB score for Canadian immigration and citizenship with our specialized CELPIP training program. Join 3000+ successful students!"
      />
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600">
                Completed your CELPIP with AIMS? Share your experience and help
                future students!
              </p>
            </motion.div>
