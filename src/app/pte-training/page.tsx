...
export const metadata: Metadata = {
  ...
  description:
    "Achieve your target PTE Academic score with AIMS expert coaching. Comprehensive PTE training covering Speaking, Writing, Reading, Listening. 95% success rate with real exam simulation. Free mock tests, personalized feedback. Join 3000+ successful students in Surrey, Canada & Ferozepur, India.",
  keywords: [
    "PTE training",
    "PTE coaching",
    "PTE preparation",
  ...
  openGraph: {
    ...
    description:
      "Expert PTE Academic preparation with real exam simulation. Join 3000+ successful students. Free demo class available!",
